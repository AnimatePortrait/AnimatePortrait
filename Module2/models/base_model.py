        ...
        for name in self.model_names:
            if isinstance(name, str):
                ...
                if len(self.gpu_ids) > 0 and torch.cuda.is_available():
                    ...
                    if self.opt.model not in ['geom_cycle_gan_multi','geom_gan_multi'] or name[0] != 'D':
                        net.cuda(self.gpu_ids[0])
                    else:
                        net.cuda(self.opt.gpu_ids_p[0])
                else:
    ...
    def print_networks(self, verbose):
        ...
        for name in self.model_names:
            if isinstance(name, str):
                ...
                if verbose:
                    for name1,param in net.named_parameters():
                        print(name1,param.size())
                    print(net)
